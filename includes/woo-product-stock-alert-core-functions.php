            ...
            'general' => array(
                ...
                'modulename'      => [
                    ...
                    [
                        ...
                        'placeholder' => __('Kindly check your inbox to confirm the subscription.', 'woocommerce-product-stock-alert-pro'),
                    ...
                    [
                        ...
                        'placeholder' => __('Product in demand: %no_of_subscribed% waiting.', 'woocommerce-product-stock-alert'),
            ...
            'form_submission' => array(
                ...
                'modulename'      => [
                    [
                        ...
                        'type'      => 'textarea',
                        'class'     => 'woo-setting-wpeditor-class',
                        'placeholder'   => __('Thank you for expressing interest in %product_title%. We will notify you via email once it is back in stock.', 'woocommerce-product-stock-alert'),
                    ...
                    [
                        ...
                        'type'      => 'textarea',
                        'class'     => 'woo-setting-wpeditor-class',
                        'placeholder'   => __('%customer_email% is already registered for %product_title%. Please attempt a different email address.', 'woocommerce-product-stock-alert'),
                    ...
                    [
                        ...
                        'type'      => 'textarea',
                        'class'     => 'woo-setting-wpeditor-class',
                        'placeholder'   => __('Please enter a valid email ID and try again.', 'woocommerce-product-stock-alert'),
                    ...
                    [
                        ...
                        'type'      => 'textarea',
                        'class'     => 'woo-setting-wpeditor-class',
                        'placeholder'   => __('%customer_email% is successfully unregistered.', 'woocommerce-product-stock-alert'),
