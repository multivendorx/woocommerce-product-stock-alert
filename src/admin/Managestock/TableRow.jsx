...
const TableRow = ({ row, headers, setData, event, setEvent }) => {
  ...
  const expandRow = (e) => {
    ...
    expander.style.display =
      expander.style.display === "none" ? "block" : "none";
      ...
      <div className="custom-container-inner-div right">
        ...
        >
          ...
          <div className="input-edit">
            <input
              id={
                row.product_type === "variation" ? row.parent_product_id : null
              }
              type="text"
              class="input-field input-field-edit"
        ...
        <div
          class="cell div-regular-price"
          onMouseOver={handleInputMouseOver}
          onMouseOut={handleInputMouseOut}
        >
          {/* Product Regular Price */}
          <div className="title">
            <p>{headers.regular_price}</p>
          </div>
          <div className="input-edit">
            <input
              id={
              ...
              value={
                ...
                row.product_regular_price === null
                  ? 0
                  : row.product_regular_price
              }
        ...
        <div
          class="cell div-sale-price"
          onMouseOver={handleInputMouseOver}
          onMouseOut={handleInputMouseOut}
        >
          {/* Product Sale Price */}
          <div className="title">
            <p>{headers.sale_price}</p>
          </div>
          <div className="input-edit">
            <input
              id={
              ...
              min={0}
              class="input-field input-field-edit"
              value={row.product_sale_price === "" ? 0 : row.product_sale_price}
              name={"set_sale_price"}
              onChange={(e) => {
                handleChange(
                  e,
        ...
        {row.product_manage_stock ? (
          row.product_stock_quantity > 0 || row.variation_stock_quantity > 0 ? (
            <div className="cell div-stock-status">
              <div className="title">
                <p>{headers.stock_status}</p>
              </div>
              <p class="value-sucess">
        ...
        <div className="cell div-backorder">
          ...
          {row.product_manage_stock ? (
            ...
            >
              <option value={"no"}>
                {__("No", "woocommerce-stock-manager-pro")}
              </option>
              <option value={"notify"}>
                {__("Notify", "woocommerce-stock-manager-pro")}
              </option>
              <option value={"yes"}>
                {__("Yes", "woocommerce-stock-manager-pro")}
              </option>
            </select>
          ) : (
            ...
            >
              ...
              <div className="input-edit">
                <input
                  ...
                  value={
                    row.product_stock_quantity === null ||
        ...
        <div className="cell div-subcriberno">
          <div className="title">
            <p>{headers.subscribers}</p>
          </div>
