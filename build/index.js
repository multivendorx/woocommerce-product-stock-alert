...
/***/ "./src/admin/DynamicForm/index.js":
/*!****************************************!*\
  !*** ./src/admin/DynamicForm/index.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ DynamicForm)
/* harmony export */ });
...
class DynamicForm extends (react__WEBPACK_IMPORTED_MODULE_2___default().Component) {
  state = {};
  constructor(props) {
    super(props);
    this.state = {
  ...
  onSubmit = e => {
    ...
    const prop_submitbutton = this.props.submitbutton && this.props.submitbutton === 'false' ? '' : 'true';
  ...
  onChange = (() => {
    ...
    return function (e, key) {
      ...
      let from_type = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '';
      let array_values = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : [];
      if (type === 'single') {
        if (from_type === 'select') {
          _this.setState({
        ...
        const found = _this.state[key] ? _this.state[key].find(d => d === e.target.value) : false;
        if (found) {
          const data = _this.state[key].filter(d => {
            return d !== found;
          });
          _this.setState({
            [key]: data
          ...
          const others = _this.state[key] ? [..._this.state[key]] : [];
          _this.setState({
            [key]: [e.target.value, ...others]
          });
        }
      }
      if (_this.props.submitbutton && _this.props.submitbutton === 'false') {
        if (key != 'password') {
          setTimeout(() => {
            _this.onSubmit('');
          }, 10);
  ...
  renderForm = () => {
    ...
    const formUI = model.map((m, index) => {
      ...
      if (type === 'text' || 'url' || 0 || 0 || 0) {
        input = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
          className: "mvx-settings-basic-input-class"
        }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("input", (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, props, {
        ...
        })), m.desc ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("p", {
      ...
      if (type === 'color') {
        input = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
          className: "mvx-settings-color-picker-parent-class"
        }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("input", (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, props, {
      ...
      if (type === 'blocktext') {
        input = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
          className: "mvx-blocktext-class"
        }, m.blocktext ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("p", {
      ...
      if (type === 'textarea') {
        input = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
          className: "mvx-setting-from-textarea"
        }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("textarea", (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, props, {
      ...
      if (type === 'checkbox') {
        input = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
          className: m.right_content ? 'mvx-checkbox-list-side-by-side' : m.parent_class ? 'mvx-checkbox-list-side-by-side' : ''
        }, m.select_deselect ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
          className: "mvx-select-deselect-trigger",
          onClick: e => {
            this.onSelectDeselectChange(e, m);
          }
        }, "Select / Deselect All") : '', m.options.map(o => {
          ...
          return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
            className: m.right_content ? 'mvx-toggle-checkbox-header' : m.parent_class ? m.parent_class : ''
          }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)((react__WEBPACK_IMPORTED_MODULE_2___default().Fragment), {
            key: 'cfr' + o.key
          }, m.right_content ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("p", {
            className: "mvx-settings-metabox-description",
            dangerouslySetInnerHTML: {
              __html: o.label
            }
          }) : '', (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
            className: "mvx-toggle-checkbox-content"
          }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("input", (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, props, {
            className: m.class,
            type: type,
          ...
          }), o.hints ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("span", {
            className: "dashicons dashicons-info"
          }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
            className: "mvx-hover-tooltip"
          }, o.hints)) : ''));
        }), m.desc ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("p", {
          className: "mvx-settings-metabox-description",
          dangerouslySetInnerHTML: {
      ...
      return m.type === 'section' || m.label === 'no_label' ? input : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
        key: 'g' + key,
  ...
  render() {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
      ...
      className: "mvx-woo-stock-alert icon-success-notification"
...
/* harmony import */ var _tabs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./tabs */ "./src/admin/tabs.js");





class StockAlert_Backend_Endpoints_Load extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
  constructor(props) {
    super(props);
    this.state = {};
  ...
  useQuery() {
    return new URLSearchParams((0,react_router_dom__WEBPACK_IMPORTED_MODULE_4__.useLocation)().hash);
  }
  Stockalert_backend_endpoint_load() {
    ...
    $('ul.wp-submenu a', menuRoot).each(function (index, el) {
      if ($(el).attr('href') === currentPath) {
        ...
        if ($(el).parent().hasClass('wp-first-item') && currentPath === 'admin.php?page=product-stock-alert') {
          $(el).parent().addClass('current');
        }
      }
    });
    ...
    if (location.get('tab') && location.get('tab') === 'settings') {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_tabs__WEBPACK_IMPORTED_MODULE_3__["default"], {
  ...
  render() {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_5__.BrowserRouter, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(this.Stockalert_backend_endpoint_load, null));
  }
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (StockAlert_Backend_Endpoints_Load);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ TabSection)
/* harmony export */ });
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
...
const override = _emotion_react__WEBPACK_IMPORTED_MODULE_4__.css`
	...
	border-color: red;
`;
class TabSection extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
  state = {};
  constructor(props) {
    super(props);
    this.state = {
  ...
  renderTab = () => {
    ...
    const TabUI = Object.entries(model).length > 0 ? Object.entries(model).map((m, index) => {
      return this.props.subtab === m[0] ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    }, this.props.no_tabs ? '' : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _admin_stockalert__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./admin/stockalert */ "./src/admin/stockalert.jsx");
...
(0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.render)((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_admin_stockalert__WEBPACK_IMPORTED_MODULE_1__["default"], null), document.getElementById('mvx-admin-stockalert'));
})();
